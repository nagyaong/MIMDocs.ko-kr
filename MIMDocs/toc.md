...
## [지원되는 언어](microsoft-identity-manager-2016-language-support.md)
...
## [라이선싱 및 다운로드 중](microsoft-identity-manager-licensing.md)
## [데이터 처리](mim-privacy-compliance.md)
## [처음 배포](microsoft-identity-manager-deploy.md)
### [도메인 설정](preparing-domain.md)
### [서버 설정: Windows Server](prepare-server-ws2016.md)
### [서버 설정: SQL](prepare-server-sql2016.md)
### [서버 설정: SharePoint](prepare-server-sharepoint.md)
### [서버 설정: Exchange](prepare-server-exchange.md)
...
### [Managing Smart Card Applications (스마트 카드 애플리케이션 관리)](https://technet.microsoft.com/library/cc708681)
...
## [Microsoft ID 소프트웨어: 공용 릴리스 빌드 버전](https://blogs.technet.microsoft.com/iamsupport/idmbuildversions/)
...
#### [웹 서비스 커넥터 가져오기](./reference/microsoft-identity-manager-2016-ma-ws-import.md)
### BHOLD
