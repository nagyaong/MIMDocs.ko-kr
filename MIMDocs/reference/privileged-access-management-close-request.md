---
title: "PAM 요청 닫기 | Microsoft Docs"
description: 
keywords: 
author: msmbaldwin
ms.author: mbaldwin
...
---
# <a name="close-pam-request"></a>PAM 요청 닫기
PAM 역할로 상승시키기 위해 시작된 요청을 닫기 위해 권한 있는 계정에서 사용합니다.
...
매개 변수 | 설명
----------|-----------
requestId | 닫을 PAM 요청의 식별자(GUID)입니다. `guid'xxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx'`
